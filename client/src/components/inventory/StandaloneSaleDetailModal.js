...
import { getStandaloneSale, addSalePayment } from './inventoryApi';
...
export default function StandaloneSaleDetailModal({ saleId, onClose }) {
    ...
    return (
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content" style={{ maxWidth: 700, display: 'flex', flexDirection: 'column', maxHeight: '85vh' }} onClick={e => e.stopPropagation()}>
                ...
                <div className="modal-body" style={{ overflowY: 'auto', paddingRight: '8px', flex: 1 }}>
                    ...
                    {!isPaid && (
                        !showPayForm ? (
                            ...
                            <div style={{ background: '#F8F9FA', borderRadius: 8, padding: 16, border: '1px solid var(--color-border-light)', marginBottom: 10 }}>
